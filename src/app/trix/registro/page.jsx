...
import { UserPlus, Eye, EyeOff, Mail, Lock, User, AlertCircle, CheckCircle, Briefcase } from 'lucide-react';

export default function TrixRegistro() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://backend-hackathon-t4q9.onrender.com/api/auth/registro', {
                method: 'POST',
                headers: {
            ...
            if (typeof window !== 'undefined') {
                ...
                console.log('Registro exitoso:', dataToStore);
            }
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    width: '400px',
                    height: '400px',
                    background: 'radial-gradient(circle, rgba(103,186,205,0.15), transparent)',
                    borderRadius: '50%',
                    filter: 'blur(80px)',
                ...
                <div style={{
                    ...
                    width: '500px',
                    height: '500px',
                    background: 'radial-gradient(circle, rgba(112,234,240,0.15), transparent)',
                    borderRadius: '50%',
                    filter: 'blur(90px)',
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            boxShadow: '0 8px 30px rgba(103,186,205,0.3)',
                            border: '3px solid rgba(103,186,205,0.3)'
                        }}>
                            <img
                                src="/img/trix.png"
                                alt="TRIX"
                    ...
                    <p style={{
                        ...
                        Únete a TRIX y optimiza tu inventario
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    boxShadow: '0 25px 70px rgba(103,186,205,0.2)'
                }}>
                    <div>
                        {/* Nombre Field */}
                            ...
                            <div style={{ position: 'relative' }}>
                                ...
                                <input
                                    ...
                                    onFocus={(e) => {
                                        ...
                                        e.target.style.boxShadow = '0 0 0 3px rgba(103,186,205,0.1)';
                                    }}
                                    onBlur={(e) => {
                        ...
                        {error && (
                            <div style={{
                                ...
                                <AlertCircle style={{ width: '1.3rem', height: '1.3rem', color: '#EF4444', flexShrink: 0 }} />
                                <p style={{
                                    margin: 0,
                                    color: '#DC2626',
                                    fontSize: '0.95rem',
                        ...
                        {success && (
                            <div style={{
                                ...
                                <CheckCircle style={{ width: '1.3rem', height: '1.3rem', color: '#22C55E', flexShrink: 0 }} />
                                <p style={{
                                    margin: 0,
                                    color: '#16A34A',
                                    fontSize: '0.95rem',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: loading
                                    ...
                                    : 'linear-gradient(135deg, #276A7C, #67BACD)',
                                color: '#FFFFFF',
                                fontSize: '1.15rem',
                                fontWeight: '700',
                                border: 'none',
                                ...
                                boxShadow: '0 10px 30px rgba(103,186,205,0.4)',
                                fontFamily: 'Quicksand, sans-serif',
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                            ...
                            onMouseLeave={(e) => {
                                if (!loading) {
                                    ...
                                    e.target.style.boxShadow = '0 10px 30px rgba(103,186,205,0.4)';
                                }
                            }}
                        >
                            {loading ? (
                                ...
                                <>
                                    Crear Cuenta
                                    <UserPlus style={{ width: '1.3rem', height: '1.3rem' }} />
                                </>
                            )}
                        </button>
                    </div>
                    ...
                    <div style={{
                        ...
                        <div style={{ flex: 1, height: '2px', background: 'rgba(103,186,205,0.2)' }}></div>
                        <span style={{
                            color: '#999999',
                            fontSize: '0.9rem',
                            fontFamily: 'Quicksand, sans-serif',
                    ...
                    <div style={{
                        ...
                        onClick={() => window.location.href = '/trix/login'}
                        onMouseEnter={(e) => {
                ...
                <div style={{ textAlign: 'center', marginTop: '2rem' }}>
                    <div style={{
                        ...
                        onMouseEnter={(e) => e.target.style.color = '#276A7C'}
